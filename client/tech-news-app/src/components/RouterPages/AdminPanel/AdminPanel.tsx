...
class AdminPanel extends React.Component<Props, State> {
    ...
    handleOpenModal = () => {
        let postId = this.state.delPostId;
        if (postId && postId > 0 && !(String(postId).indexOf('.') > 0))
    ...
    onFieldsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        this.setState({delPostId: Number(e.target.value)});
    }

    onDeletePost = () => {
        this.props.deletePostById(this.state.delPostId);
        this.setState({openModal: false});
    }
                                ...
                                <div className="box-body">
                                    ...
                                    <Dialog open={this.state.openModal}
                                        ...
                                        <DialogTitle id="alert-dialog-title">
                                            {`Удалить пост #${this.state.delPostId}`}
                                        </DialogTitle>
