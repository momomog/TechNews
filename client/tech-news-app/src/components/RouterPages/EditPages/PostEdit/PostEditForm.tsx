...
class PostEditForm extends React.Component<InjectedFormProps<PostRequest, OwnProps> & OwnProps, State> {
    constructor(props) {
        super(props);
        this.state = {
            isInitialized: false
    ...
    componentDidUpdate() {
        ...
        if (post && post.id && !this.state.isInitialized) {
            ...
            <form onSubmit={this.props.handleSubmit}>
                ...
                <div className="p-3 ml-4 mr-4">
                    <Field component={PostDescription}
                           ...
                           initValue={this.props.post.fullDescription}
                           validate={[
                               required,
                               minLength1000,
                               maxLength20000
