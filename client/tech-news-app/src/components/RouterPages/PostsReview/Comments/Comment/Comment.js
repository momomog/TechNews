...

                        {
                            this.state.isEditMode && this.state.commentId === id
                                ? <div>
                                    ...
                                    />
                                    <span>
                                        <a className="text-secondary comment-action" onClick={this.updateCommentary}>
                                            Сохранить
                                        </a>
                                        <a className="text-secondary comment-action ml-4" onClick={() => {
                                            this.setState({isEditMode: false})
                                        }}>
                                            Отменить
                                        </a>
...

                                            {
                                                ...
                                                <span>
                                                         <a onClick={this.onClickAnswerCommentary}
                                                            className="text-secondary comment-action ml-4">Ответить</a>
                                                      </span>
                                            }

                                            {
                                                ...
                                                && <span className="ml-3">
                                                         <a onClick={this.onClickEditCommentary}
                                                            className="text-secondary comment-action">Редактировать</a>
                                                   </span>
                                            }

                                            {
                                                ...
                                                && <span className="ml-3">
                                                          ...
                                                          <div>
                                                              ...
                                                              }} className="text-secondary comment-action ml-4">Отменить</a>
                                                          </div>
                                                          </Popup>
                                                      </span>
                                            }
