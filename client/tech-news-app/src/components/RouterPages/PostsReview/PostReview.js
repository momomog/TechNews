                    ...
                    <div className="row">
                        <div className="col-lg-10 center-block">
                            <Hyphenated language={ru}>
                                <h2 className="mt-4" align="justify">
                                    {post.title}
                                </h2>
                            </Hyphenated>
                            ...
                            <div className="post-desc" align="justify">

                                    {
                                        post.fullDescription && <Hyphenated language={ru}>{Parser(post.fullDescription)}</Hyphenated>
                                    }
                                ...
                                <div className="ml-4">
                                    {
                                        this.state.isRating
                                            ...
                                            : AuthService.isAuth() ? <div className="rating">
                            ...
                            <TrackVisibility once partialVisibility>
                                <RecommendedPostsWrapper categoryId={this.props.post.categoryId}
