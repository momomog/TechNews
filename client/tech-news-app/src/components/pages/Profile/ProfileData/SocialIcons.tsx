 ...
 */
const SocialIcons: React.FC<Props> = ({user}: Props) => {
                    ...
                    ? (
                        <a href={`https://www.facebook.com/${profileData.facebook}`}
                           target="_blank" rel="noopener noreferrer">
                            <i id="social-fb" className="facebook-icon active-soc"/>
                        </a>
                    )
                ...
                profileData.instagram
                    ? (
                        <a href={`https://www.instagram.com/${profileData.instagram}`}
                           target="_blank" rel="noopener noreferrer">
                            <i id="social-gp" className="instagram-icon active-soc"/>
                        </a>
                    )
                ...
                profileData.twitter
                    ? (
                        <a href={`https://www.twitter.com/${profileData.twitter}`}
                           target="_blank" rel="noopener noreferrer">
                            <i id="social-tw" className="twitter-icon active-soc"/>
                        </a>
                    )
